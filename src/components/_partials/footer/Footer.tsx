...
export const Footer = () => {
  return (
    <div className="relative left-0 bg-cover bg-center" style={{
      ...
      <div
        className=" bg-gradient-to-r from-[#6dbd49] to-[#3bc2d6] h-1 w-2/3 mx-auto rounded-full my-5 scroll_animate overflow-x-hidden"
        data-aos="fade-right"
      ></div>
