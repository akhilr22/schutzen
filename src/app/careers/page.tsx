...
export default function page() {
  return (
    ...
    >
      <div className="justify-center text-center mt-5 xl:mt-10">
        ...
        <p className="flex mx-auto md:text-xl w-3/4 md:w-2/4 text-center justify-center">
          <span>
            At Schutzen Healthtech, we are committed to transforming healthcare through innovation. Let&apos;s bring
