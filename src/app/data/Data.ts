export const homePageData = {
    ...
    whyChooseUs: {
        ...
        title_1: "Innovative Technology",
        desc_1: "Our products are designed to meet these needs by integrating the latest advancements in technology to deliver exceptional results. From real-time patient monitoring systems to AI-driven diagnostic tools, we ensure that healthcare providers have access to the most accurate and up-to-date information.",
        img_url_2: "",
    ...
    features:{
        title: "Patient Monitoring for Hospitals and Beyond",
